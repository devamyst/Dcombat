package com.devamy.dcombat.bridge.placeholder;

import com.devamy.dcombat.config.implementation.PlaceholderSettings;
...
public class FightTagPlaceholder extends PlaceholderExpansion {
    ...
    private static final String IDENTIFIER = "dcombat";
